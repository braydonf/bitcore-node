...
function AddressHistory(args) {
  ...
  this.maxTransactions = args.maxTransactions;
...
AddressHistory.prototype.getTransactionInfo = function(address, next) {
  ...
  async.parallel([
    ...
    if (self.maxTransactions && self.transactionInfo.length > self.maxTransactions) {
      var errorMessage = 'Maximum transactions for a query (' +
        self.maxTransactions +
        ') has been reached, please limit to a smaller query.';
