...
exports.encodeOutputKey = function(hashBuffer, hashTypeBuffer, heightBuffer, txidBuffer, outputIndexBuffer) {
  var key = Buffer.concat([
...
exports.encodeInputValueMap = function(inputTxIdBuffer, inputIndex, heightBuffer) {
...
exports.decodeInputValueMap = function(buffer) {
  ...
  var height = buffer.readUInt32BE(36);
  return {
    inputTxId: txid,
